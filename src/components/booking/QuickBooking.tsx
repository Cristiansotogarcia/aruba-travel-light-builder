      ...
      <CardContent className="space-y-3 sm:space-y-4">
        <div className="text-xs sm:text-sm text-gray-700 leading-relaxed">
          <ul className="list-disc list-inside space-y-2">
            <li>Sunday bookings have special requirements and limited time slots.</li>
            <li>Minimum rental and delivery rules apply.</li>
            <li>Delivery fees may apply for certain dates.</li>
          </ul>
        </div>
