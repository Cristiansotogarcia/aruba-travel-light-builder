...
export const CreateBookingModal = ({ onBookingCreated, preselectedDate }) => {
    ...
    const addEquipment = () => {
        ...
        if (existingItem) {
            setBookingItems(items => items.map(item => item.equipmentId === selectedEquipment
    ...
    const updateQuantity = (equipmentId, change) => {
        setBookingItems(items => items.map(item => item.equipmentId === equipmentId
