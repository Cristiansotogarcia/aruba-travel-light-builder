...
type BookingRow = Pick<
  ...
  'id' | 'start_date' | 'end_date' | 'status' | 'total_amount' | 'customer_name' | 'created_at' | 'updated_at'
> & {
  booking_items?: Array<{
              ...
              {data?.business.equipmentUtilization.length ? (
                <ResponsiveContainer width="100%" height={400}>
                  <BarChart data={data.business.equipmentUtilization} layout="vertical" margin={{ top: 5, right: 30, left: 100, bottom: 5 }}>
                    ...
                    <Tooltip formatter={(value) => [Array.isArray(value) ? (value[0] ?? 0) : (value ?? 0), 'Times Booked']} />
