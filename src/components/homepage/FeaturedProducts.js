                ...
                _jsxs("div", { 
                    ...
                    children: [
                        _jsx("h2", { 
                            ...
                            children: "Popular Equipment" 
                        }), 
                        _jsx("p", { 
                            className: "text-xl text-gray-600 max-w-2xl mx-auto", 
                            children: "Discover our most popular rental items" 
                        }) 
                    ] 
                }), 
                _jsx("div", { 
                    className: "grid md:grid-cols-3 gap-8", 
                    children: sortedProducts.map((product) => _jsxs(Card, { 
                        key: product.id, 
                        className: "overflow-hidden hover:shadow-lg transition-shadow", 
                        children: [
                            product.image_url && _jsx("img", { 
                            ...
                            _jsxs(CardContent, { 
                                children: [
                                    product.description && _jsx("p", { 
                                        className: "text-gray-600 mb-2 line-clamp-3", 
                                        children: product.description 
                                    }), 
                                    _jsxs("div", { 
                                        className: "text-lg font-bold mb-4", 
                                        children: ["$", Number(product.price_per_day).toFixed(2), "/day"] 
                                    }), 
                                    _jsx(Link, { 
                                        to: "/equipment", 
                                        className: "block", 
